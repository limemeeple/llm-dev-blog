...
```
C:\Users\중진공18\AppData\Local\Programs\Python\Python314\python.exe: can't open file 'C:\\llm-rag-qa\\venv\\rag.py': [Errno 2] No such file or directory
```
...
File "C:\llm-rag-qa\rag.py", line 58, in <module>
    ...
    embed_model = TextEmbedding("intfloat/multilingual-e5-small")
                  ...
                  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
 File "C:\Users\중진공18\AppData\Local\Programs\Python\Python312\Lib\site-packages\fastembed\text\text_embedding.py", line 126, in __init__
